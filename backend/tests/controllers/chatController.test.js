...
describe('Chat Controller', () => {
  ...
  describe('getUserChats', () => {
    it('should return tenant chats successfully', async () => {
      const mockChats = [
        {
          id: 'chat-1',
          tenant_id: 'tenant-1',
      ...
      mockReq.params = { userId: 'tenant-1', userType: 'tenant' };
      global.mockPrisma.chats.findMany.mockResolvedValue(mockChats);
      ...
      expect(global.mockPrisma.chats.findMany).toHaveBeenCalledWith({
    ...
    it('should return landlord chats successfully', async () => {
      const mockChats = [
        {
          id: 'chat-1',
          tenant_id: 'tenant-1',
      ...
      mockReq.params = { userId: 'landlord-1', userType: 'landlord' };
      global.mockPrisma.chats.findMany.mockResolvedValue(mockChats);
      global.mockPrisma.tenant_profiles.findUnique.mockResolvedValue({
        id: 'tenant-1',
        full_name: 'Test Tenant',
